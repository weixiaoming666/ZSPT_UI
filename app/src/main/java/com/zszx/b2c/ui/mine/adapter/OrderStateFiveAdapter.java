...
import com.zszx.b2c.ui.mine.RefundActivityThreeActivity;
import com.zszx.b2c.utils.ToastUtil;

import java.util.HashMap;
import java.util.Map;

public class OrderStateFiveAdapter extends BaseExpandableListAdapter {
    public  Map<Integer,Boolean> mList   = new HashMap<>();
    private boolean              checked = false;
    private Context        mContext;
    private LayoutInflater mInflater;
    public OrderStateFiveAdapter(Context context) {
        mContext = context;
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (childPosition == 2){
            ...
            childViewHolder.tv_cancel.setVisibility(View.GONE);
            childViewHolder.tv_pay.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    ToastUtil.showShort(mContext,"查看详情");
                    mContext.startActivity(new Intent(mContext,RefundActivityThreeActivity.class));
                }
            });
        }else {
