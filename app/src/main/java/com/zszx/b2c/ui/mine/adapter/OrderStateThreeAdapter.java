...
public class OrderStateThreeAdapter  extends BaseExpandableListAdapter {
    public  Map<Integer,Boolean> mList   = new HashMap<>();
    private boolean              checked = false;
    private Context        mContext;
    private LayoutInflater mInflater;
    public OrderStateThreeAdapter(Context context) {
        mContext = context;
        ...
        if (childPosition == 2){
            ...
            childViewHolder.tv_cancel.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ToastUtil.showShort(mContext,"再次购买");
                }
            });
            childViewHolder.tv_pay.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    ToastUtil.showShort(mContext,"确认收货");
                }
            });
        }else {
