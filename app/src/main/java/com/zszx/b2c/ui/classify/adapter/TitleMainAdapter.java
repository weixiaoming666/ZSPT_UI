...
public class TitleMainAdapter extends MyBaseAdapter {
    LayoutInflater inflater;
    private Context context;
    boolean check_set = true;
    int check_position = 0;
    CheckPositionCallBack mCallBack;
    List<ClassTitleBean.DataBeanX.DataBean>  datas;
    public TitleMainAdapter(Context context,  List<ClassTitleBean.DataBeanX.DataBean> data, CheckPositionCallBack checkPositionCallBack) {
    ...
    public View getContenView(final int i, View view, ViewGroup viewGroup) {
        ...
        check_set = true;
        if (view == null){
            view = inflater.inflate(R.layout.item_classify_title_main,null);
