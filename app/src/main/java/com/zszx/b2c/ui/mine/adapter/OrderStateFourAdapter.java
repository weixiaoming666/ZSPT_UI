...
import com.zszx.b2c.ui.mine.OrderDetialsActivity;
import com.zszx.b2c.ui.mine.RefundActivity;
import com.zszx.b2c.utils.ToastUtil;

import java.util.HashMap;
import java.util.Map;

public class OrderStateFourAdapter extends BaseExpandableListAdapter {
    public  Map<Integer,Boolean> mList   = new HashMap<>();
    private boolean              checked = false;
    private Context        mContext;
    private LayoutInflater mInflater;
    public OrderStateFourAdapter(Context context) {
        mContext = context;
        ...
        if (childPosition == 2){
            ...
            childViewHolder.tv_cancel.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ToastUtil.showShort(mContext,"退货");
                    mContext.startActivity(new Intent(mContext,RefundActivity.class));
                }
            });
            childViewHolder.tv_pay.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    ToastUtil.showShort(mContext,"去评价");
                    mContext.startActivity(new Intent(mContext,OrderDetialsActivity.class));
                }
            });
        }else {
    ...
    class GroupViewHolder{
        ...
        private GroupViewHolder(View view) {
            ...
            tv_time.setText("订单编号：AKJ7386317623");
